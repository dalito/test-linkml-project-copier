# Contributing to test-linkml-project-copier

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
test-linkml-project-copier. These guidelines are not strict rules.
...
The test-linkml-project-copier team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the test-linkml-project-copier technical leads
...
[issues]: https://github.com/dalito/test-linkml-project-copier/issues/
[pulls]: https://github.com/dalito/test-linkml-project-copier/pulls/
