...
linkml_meta = LinkMLMeta(
    {
        "default_prefix": "test_linkml_project_copier",
        ...
        "prefixes": {
            ...
            "test_linkml_project_copier": {
                "prefix_prefix": "test_linkml_project_copier",
...
class Person(NamedThing):
    ...
    age_in_years: Optional[int] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "age_in_years", "domain_of": ["Person"]}
        },
    )
    vital_status: Optional[PersonStatus] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "vital_status", "domain_of": ["Person"]}
        },
    )
    id: str = Field(
        default=...,
